const productos = [
  {
    ...
    descripcion:"iPhone 13 Pro Max. El mayor avance en el sistema de cámaras Pro hasta ahora. Pantalla Super Retina XDR con ProMotion que brinda una respuesta más rápida y fluida. Chip A15 Bionic para un rendimiento fuera de serie. Diseño resistente y la mayor duración de batería jamás vista en un iPhone.1"
  },
  {
    id:"1",
    nombre: "Samsung S23",
    ...
    imagen:
      ...
      descripcion:"Memoria RAM: 8 GB, Galaxy S23 con 256GB de almacenamiento interno y 8GB de RAM, Equipado con el último sistema operativo Android 13,Cuenta con una pantalla Dynamic AMOLED 2X de 6.1 pulgadas Full HD+,Triple cámara trasera de 50MP, 10MP y 12MP con funciones como autoenfoque y modo retrato."
  },
  {
    id:"2",
  ...
  },
  {
    ...
    imagen:
      ...
      descripcion:"Rendimiento de siguiente nivel con 13th Gen Intel Core  Maximiza tu día con el último procesador 13th Gen Intel Core, que ofrece un rendimiento rápido y confiable para una alta productividad y múltiples tareas."
  },
];
